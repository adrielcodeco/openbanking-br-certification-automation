...
nconf.file({ file: 'obbtest.config.json', dir: process.cwd(), search: true })
...
class TestPlanConfig {
  ...
  get skipTests() {
    return nconf.get(`plans:${this.#testEngineUrl}:${this.#testPlan}:skipTests`)
  }
  set skipTests(value) {
    nconf.set(`plans:${this.#testEngineUrl}:${this.#testPlan}:skipTests`, value)
  }
}
